...
int main (int argc, char *argv[]){
	...
	std::string exppath = "/Users/hakunahahannah/Documents/Projects/Spiking2.0/Build/output/" + experimentName;
	std::string initpath = "/Users/hakunahahannah/Documents/Projects/Spiking2.0/Build/output/" + experimentName + "/initial";
	std::string trainpath = "/Users/hakunahahannah/Documents/Projects/Spiking2.0/Build/output/" + experimentName + "/training";
	std::string testpath = "/Users/hakunahahannah/Documents/Projects/Spiking2.0/Build/output/" + experimentName + "/testing";
	...
	for (int g = starting_epoch; g <= number_of_epochs_train; g++){
		...
		if (simulate_network_to_test_trained) {
			...
			for (int stimulus_index = 0; stimulus_index < input_neurons->total_number_of_input_stimuli; stimulus_index++){
		    	...
		    	//create epoch folder
				std::string epochpath = "/Users/hakunahahannah/Documents/Projects/Spiking2.0/Build/output/" + experimentName + "/testing/epoch" + to_string(g);
